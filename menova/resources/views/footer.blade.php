   <footer>
              <div class="container">
                  ...
                  <hr />
                  <div class="rights">
                      &copy all rights reserved menaova.me 2020
                  </div>
              </div>
          </footer>
          <!-- endfooter footer -->
...
<script src="{{ URL::asset('../public/js/map.js') }}" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
